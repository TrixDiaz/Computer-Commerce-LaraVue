...
let trendingsUrl = computed(() => {
  let url = new URL(route("trending.index"));
...
watch(
  () => trendingsUrl.value,
  (updatetrendingUrl) => {
    router.visit(updatetrendingUrl, {
      preserveScroll: true,
      preserveState: true,
      replace: true,
    });
...
const deleteStudent = (trendingId) => {
  if (confirm("Are you sure you want to delete this trend?")) {
    deleteForm.delete(route("trending.destroy", trendingId));
  }
};
</script>
    ...
    <div>
      ...
      <div class="mx-auto max-w-full">
        <section class="flex items-center">
          <div class="w-full">
            <p class="p-4 font-medium text-xl Capitalize">View all trendings</p>
              ...
              >
                <div class="w-full md:w-1/2">
                  <form class="flex flex-row items-center gap-2">
                    ...
                    <Link :href="route('trending.index')">Reset</Link>
                  </form>
                </div>
                <div
                ...
                >
                  <Link :href="route('trending.create')">
                    <PrimaryButton> Add trending </PrimaryButton>
                  </Link>
                  ...
                  <div class="flex items-center w-full space-x-2 md:w-auto">
                    ...
                    >
                      ...
                      >
                        <li>
                          <Link
                            @click.prevent="sorttrendings('asc')"
                            href="#"
                        ...
                        <li>
                          <Link
                            @click.prevent="sorttrendings('desc')"
                            href="#"
                            class="block px-4 py-2 hover:bg-gray-100 capitalize"
                            >sort by z-a
                          </Link>
        ...
        <div class="mt-4 flex flex-col">
          <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
              ...
              >
                <table class="min-w-full divide-y divide-gray-300">
                  ...
                  <tbody class="divide-y divide-gray-200 bg-white">
                    <tr v-for="trending in trendings.data" :key="trending.id">
                      <td
                      ...
                      >
                        <Link
                          :href="route('trending.edit', trending.id)"
                          class="text-slate-600 hover:text-slate-900"
                        >
                          Edit
                        </Link>
                        <button
                          @click="deleteStudent(trending.id)"
              ...
              <Pagination :data="trendings" :pageNumberUpdated="pageNumberUpdated" />
            </div>
          </div>
        </div>
      </div>

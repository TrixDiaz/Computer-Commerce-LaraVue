<template>
    <div>
        <h2 class="my-4 text-4xl text-center font-serif  sm:text-5xl">Have Questions? Checkout these FAQs</h2>
        <p class="mb-8 text-center text-lg text-gray-600">We have written down answers to some of the frequently asked
            questions. But, if you still have any queries, feel free to ping us on chat.</p>
    </div>
    <ul class="max-w-7xl mx-auto divide-y mb-12 rounded-xl">
        <li>
            <details class="group">
